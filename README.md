            ...
            return tostring(
              " "
                   ..
                        ...
                        Gamename.. "!" .. "ยินดีต้อนรับnSAZX HUB ฮับทำไก่ตันแที!"  .."\n Loadded..."
            )
      end
   }
}
...
Main2:Toggle("Fast Attack[2]",nil,function(value)
...
Main2:Toggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
Main2:Toggle("Remove Damage",function()
...
Main2:Toggle("Fast Attack [3] ระวังโดนเตะ",false,function()
...
WeaponList = {}
    ...
    local SelectWeapona = Main2:Dropdown("Select Weapon",WeaponList,function(value)
...
Main2:Toggle("up stats",true,function()
while true do
